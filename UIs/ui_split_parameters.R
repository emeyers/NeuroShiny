...
# DS split parameters tab after selecting data source
  ...
  fluidRow(
    column(
      ...
      conditionalPanel(condition = "input.DS_type == 'ds_basic'",
                       ...
                       uiOutput("DS_basic___np___show_chosen_repetition_info"),
      ...
      conditionalPanel(condition = "input.DS_type == 'ds_generalization'",
                       ...
                       uiOutput("DS_gen___np___show_chosen_repetition_info"),
